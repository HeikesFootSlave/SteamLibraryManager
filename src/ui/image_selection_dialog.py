...
class ImageSelectionDialog(QDialog):
    def __init__(self, parent, game_name, app_id, img_type):
        ...
        self.setWindowTitle(t('ui.dialogs.image_picker_title', type=t(f'ui.game_details.gallery.{img_type}'), game=game_name))
    ...
    def _create_ui(self):
        ...
        # Link zur API Seite
        get_key_btn.clicked.connect(lambda: QDesktopServices.openUrl(QUrl("https://www.steamgriddb.com/profile/preferences/api")))
